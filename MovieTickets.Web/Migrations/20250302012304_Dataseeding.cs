    ...
    public partial class Dataseeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Producers",
                columns: new[] { "Id", "Bio", "FullName", "ProfilePictureURL" },
                values: new object[] { 1, "This is the Bio of the first producer", "Producer 1", "http://dotnethow.net/images/producers/producer-1.jpeg" });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "CinemaId", "Description", "EndDate", "ImageURL", "MovieCategory", "Name", "Price", "ProducerId", "StartDate" },
                values: new object[] { 1, 1, "This is the Life movie description", new DateTime(2025, 3, 12, 6, 23, 4, 294, DateTimeKind.Local).AddTicks(2493), "http://dotnethow.net/images/movies/movie-3.jpeg", 3, "Life", 39.5, 1, new DateTime(2025, 2, 20, 6, 23, 4, 294, DateTimeKind.Local).AddTicks(2479) });
